...
class AbideLDMCLSModule(LightningModule):
    """Module for generating new functional connectivity.
    """
    ...
    def model_step(
        ...
        preds, sample, labels, latents = self.forward(x)
        loss = self.criterion(preds, y)
        
        return loss, preds, y, sample, labels, latents
    ...
    def training_step(
        ...
        """
        loss, preds, y, sample, labels, latents = self.model_step(batch)
